                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-9">
                                    ...
                                    <?php
//   $find = mysqli_query ($connect,"SELECT primary_payment FROM primary_payment_fees WHERE pri_active_email = '1' AND pri_admit = '1' AND pri_paid = '1'") or die(mysqli_error($connect));
