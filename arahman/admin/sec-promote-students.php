                  ...
                  <div class="card-body">
                    ...
                    ?>
                       ...
                       <?php        
                        ...
                        foreach ($sec_class_range as $sec_sec_class=>$class_id){
                        $sel_sec_class = ($sec_sec_class==$_POST['sec_class'])?"Selected='selected'":"";
                        echo '<option '.$sel_sec_class. 'value="'.$class_id.'">'.$sec_sec_class.'</option>';}
                        }else{
                        foreach ($sec_class_range as $sec_sec_class=>$class_id){
                        echo '<option value="'.$class_id.'">'.$sec_sec_class.'</option>';
                        }
                        }
                        ?>            
                        </select>
