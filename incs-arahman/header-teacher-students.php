...
<body>
     <!-- <div class="row" id="proBanner"> 
         <div class="col-12"> 
             ...
             <p><b>Announcement:</b> All teachers of Basic 6 should stay back for a meeting </p> -->
         <a  class="btn download-button  ml-auto"><i class="typcn typcn-delete-outline" id="bannerClose"></i></a>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-date dropdown">
                        <a class="nav-link d-flex justify-content-center align-items-center" >
                            <h6 class="date mb-0">Today : 
                                <script>
                                const month = ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];const d = new Date();
                    ...
                    <li class="nav-item dropdown mr-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                            ...
                            <a class="dropdown-item preview-item" href="<?php echo GEN_WEBSITE.'/teachers/logout.php';?>">
                                <div class="preview-thumbnail">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <form method="GET" action="'.GEN_WEBSITE.'/teachers/search-my-students.php">
                        <div class="input-group">
                            ...
                            if(isset($_GET['students_name'])){echo 'value="'.$_GET['students_name'].'"';}
                            
                            echo '>
                          
                            <div class="input-group-prepend">
                            <button type="submit" name="search_button" style="background:transparent; border:0;"><span class="input-group-text" id="search">
